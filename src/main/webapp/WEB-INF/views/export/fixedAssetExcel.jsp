...
<%
    ...
    response.setHeader("Content-Disposition",
            "inline; filename=\"FIXED_ASSET.xls\"");
%>
...
<table width="1359" border="0" cellpadding="0" cellspacing="0" style='width:1019.25pt;border-collapse:collapse;table-layout:fixed;'>
    ...
    <tr height="19" class="xl65" style='height:14.25pt;'>
        <td class="xl66" height="19" width="132" style='height:14.25pt;width:99.00pt;' x:str>资产编号</td>
        <td class="xl66" width="141" style='width:105.75pt;' x:str>资产名称</td>
        <td class="xl66" width="117" style='width:87.75pt;' x:str>规格</td>
        <td class="xl69" width="109" style='width:81.75pt;' x:str>资产类别</td>
        <td class="xl66" width="129" style='width:96.75pt;' x:str>使用人编号</td>
        <td class="xl69" width="109" style='width:81.75pt;' x:str>使用人姓名</td>
        <td class="xl66" width="93" style='width:69.75pt;' x:str>使用科室</td>
        <td class="xl66" width="126" style='width:94.50pt;' x:str>使用状况</td>
        <td class="xl66" width="93" style='width:69.75pt;' x:str>存放地点</td>
        <td class="xl66" width="93" style='width:69.75pt;' x:str>启用日期</td>
    </tr>
    <c:forEach var="fixedAsset" items="${requestScope.fixedAssetList}">
        <tr>
            <td class="xl67">${fixedAsset.assetNumber}</td>
            <td class="xl67">${fixedAsset.assetName}</td>
            <td class="xl67">${fixedAsset.standard}</td>
            <td class="xl67">${fixedAsset.assetClass}</td>
            <td class="xl67">${fixedAsset.assetUserId}</td>
            <td class="xl67">${fixedAsset.assetUser}</td>
            <td class="xl67">${fixedAsset.section}</td>
            <td class="xl67">${fixedAsset.useState}</td>
            <td class="xl67">${fixedAsset.storePlace}</td>
            <td class="xl71"><fmt:formatDate value="${fixedAsset.startDate}" pattern="yyyy-MM-dd"></fmt:formatDate></td>
        </tr>
    </c:forEach>
