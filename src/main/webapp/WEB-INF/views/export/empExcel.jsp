...
<table width="1359" border="0" cellpadding="0" cellspacing="0" style='width:1019.25pt;border-collapse:collapse;table-layout:fixed;'>
    ...
    <tr height="19" class="xl65" style='height:14.25pt;'>
        ...
        <td class="xl66" width="141" style='width:105.75pt;' x:str>员 工姓名</td>
        <td class="xl66" width="117" style='width:87.75pt;' x:str>员工性别</td>
        <td class="xl69" width="109" style='width:81.75pt;' x:str>入职日期</td>
        <td class="xl66" width="129" style='width:96.75pt;' x:str>工龄</td>
        <td class="xl66" width="126" style='width:94.50pt;' x:str>职级</td>
        <td class="xl66" width="93" style='width:69.75pt;' x:str>部门</td>
        <td class="xl66" width="107" style='width:80.25pt;' x:str>科室</td>
        <td class="xl66" width="114" style='width:85.50pt;' x:str>职务</td>
        <td class="xl66" width="116" style='width:87.00pt;' x:str>邮箱</td>
        <td class="xl68" width="89" style='width:66.75pt;' x:str>电话</td>
        <td class="xl66" width="86" style='width:64.50pt;' x:str>地址</td>
    </tr>
