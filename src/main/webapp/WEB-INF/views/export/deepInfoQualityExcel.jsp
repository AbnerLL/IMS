...
<%
    ...
    response.setHeader("Content-Disposition",
            "inline; filename=\"DEEP_INFO_QUALITY.xls\"");
%>
...
<head>
    ...
    <xml>
        <o:DocumentProperties>
            ...
            <o:Created>2018-03-04T20:54:09</o:Created>
            <o:LastAuthor>Louie</o:LastAuthor>
            <o:LastSaved>2018-03-04T20:55:43</o:LastSaved>
        </o:DocumentProperties>
...
<table width="829" border="0" cellpadding="0" cellspacing="0" style='width:621.75pt;border-collapse:collapse;table-layout:fixed;'>
    ...
    <tr height="18" class="xl65" style='height:13.50pt;'>
        ...
        <td class="xl66" width="98" style='width:73.50pt;' x:str>员工编号</td>
        <td class="xl66" width="99" style='width:74.25pt;' x:str>员工姓名</td>
        <td class="xl66" width="92" style='width:69.00pt;' x:str>项目组</td>
        <td class="xl66" width="103" style='width:77.25pt;' x:str>作业类型</td>
        <td class="xl66" width="107" style='width:80.25pt;' x:str>通用合格率</td>
        <td class="xl66" width="113" style='width:84.75pt;' x:str>停车合格率</td>
        <td class="xl66" width="145" style='width:108.75pt;' x:str>汽车租赁合格率</td>
    </tr>
    <c:forEach var="deepInfoQuality" items="${requestScope.deepInfoQuality}">
        <tr height="18" style='height:13.50pt;'>
            <td height="18" style='height:13.50pt;'>${deepInfoQuality.version}</td>
            <td class="xl67">${deepInfoQuality.workerId}</td>
            <td class="xl67">${deepInfoQuality.worker}</td>
            <td class="xl67">${deepInfoQuality.section}</td>
            <td class="xl67">${deepInfoQuality.workType}</td>
            <td class="xl67">${deepInfoQuality.comRate}</td>
            <td class="xl67">${deepInfoQuality.parkRate}</td>
            <td class="xl67">${deepInfoQuality.rentRate}</td>
        </tr>
    </c:forEach>
