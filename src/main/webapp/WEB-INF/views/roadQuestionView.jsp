...
<div class="container-fluid">
    <%--导航栏--%>
    <%@include file="include/workQuestionTab.jsp"%>
    <%--查询框--%>
                ...
                <div class="col-sm-11">
                    <form id="search_form" class="form-inline" role="form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group form-group-sm">
                                    <label for="auditDateStart_search_input" class="control-label">质检日期:</label>
                                    <span>
                                        <div class="input-group input-group-sm" style="width: 77%;">
                                            <input type="text" class="form-control datepicker" name="auditDateStart" id="auditDateStart_search_input" />
                                            <div class="input-group-addon"><span class="fa fa-calendar"></span></div>
                                            <input type="text" class="form-control datepicker" name="auditDateEnd" id="auditDateEnd_search_input" />
                                            <div class="input-group-addon"><span class="fa fa-calendar"></span></div>
                                        </div>
                                    </span>
                                </div>
...
//            exportDataType:"all",               //导出方式selected、all、basic
    ...
    $("#export_btn").click(function () {
        window.location.href="${basePath}/roadQuestionExcel?"+$("#search_form").serialize();
    });
</script>
</html>
