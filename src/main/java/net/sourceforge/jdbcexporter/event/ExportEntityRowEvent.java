 ...
 * @author      Chris Nagy
 */
public class ExportEntityRowEvent extends EventObject
{
	/**
	 ...
	 * @param state the state of row's export
	 * @param ex the exception that prevented the row from being exported.
	 */
	public ExportEntityRowEvent(Object source, ExportEntityDef entityDef, String line, ColumnValue[] values, int state, Exception ex )
	{
		super(source);
	...
	/**
	 * Returns the state of the export of the row. The state
