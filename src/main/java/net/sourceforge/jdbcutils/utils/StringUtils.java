...
//        }
    ...
    /**LiuBinSheng修改
     * 判断是否为整数(不包含小数点)，如果不是返回false
     * @param str 待判断的字符，可能为空
     * @return
     * 
     */
    ...
    public static void main(String args[]) {
        ...
        System.out.println(StringUtils.isNumeric(".22"));
        String aab="00";
        System.out.println(
               aab.substring(aab.length()-3, aab.length()  )
                );
    }
}
