...
/**
 * The FixedDelimiterParserBeanInfo class provides the custom property editor
...
public class FixedDelimiterParserBeanInfo extends SimpleBeanInfo 
{
		...
		throws java.beans.IntrospectionException
	{
		try
		{
			...
			descriptors[1] = new PropertyDescriptor( "length", FixedDelimiterParser.class, null, "setLength" );
		}
